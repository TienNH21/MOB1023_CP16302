 ...
 * @author tiennh
 */
public class DemoParseIntException extends javax.swing.JFrame {

    /**
     * Creates new form DemoParseIntException
     */
    public DemoParseIntException() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DemoParseIntException.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DemoParseIntException().setVisible(true);
            }
        });
    }
